...
namespace MyExpManAPI.Controllers
{
    public class CustomBaseController : ControllerBase
    {
        ...
        protected async Task<ActionResult<TDTO>> Get<TEntidad, TDTO>(string Id) where TEntidad : class, IId
        {
        ...
        protected async Task<ActionResult> Put<TCreacion, TEntidad>
            (string id, TCreacion creacionDTO) where TEntidad : class, IId
        {
            var entidad = mapper.Map<TEntidad>(creacionDTO);
            entidad.Id = id;
        ...
        protected async Task<ActionResult> Delete<TEntidad>(string id) where TEntidad : class, IId, new()
        {
        ...
        protected async Task<ActionResult> Patch<TEntidad, TDTO>(string id, JsonPatchDocument<TDTO> patchDocument) 
            where TDTO : class
